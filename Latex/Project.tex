...
\begin{figure}[htbp]
    ...
    \caption{Players with multiple red cards Executed with GB1 competition}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Players with the most minutes played Executed with ES1 competition}
\end{figure}
